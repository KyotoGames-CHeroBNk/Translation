...
#    $ allow_skipping = False
    ...
    # poem help screen
    if show_poemhelp:
        call screen dialog("Пришло время написать стихотворение!\n\nВыбери слова, которые, по твоему мнению, понравятся твоему любимому члену клуба.\nС тем, чьё стихотворение понравится больше всего, может произойти что-то хорошее!", ok_action=Return())
