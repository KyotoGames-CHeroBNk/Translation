...
image the_end:
    "mod_assets/the_end.jpg"

image mc2_cg1:
    "mod_assets/mc2_cg1.png"
image mc2_exp1:
    "mod_assets/mc2_exp1.png"
    alpha 0
    linear 0.5 alpha 1
    on hide:
        linear 0.5 alpha 0
...
#image y_cg2_smile:
#    "mod_assets/y_cg2_smile.png"
image y_cg2_smile2:
    "mod_assets/y_cg2_smile2.png"
image y_cg2_nochoc:
...
image y_cg2_exp3: #Embarrassed
    ...
    on hide:
        linear 0.5 alpha 0
image y_cg2_exp4:
    "mod_assets/y_cg2_exp4.png"
    alpha 0
    linear 0.5 alpha 1
    on hide:
        linear 0.5 alpha 0
image y_cg2_blush:
    "mod_assets/y_cg2_blush.png"
    alpha 0
    linear 0.5 alpha 1
    on hide:
        linear 0.5 alpha 0
image y_cg2_smile:
    "mod_assets/y_cg2_smile3.png"
    alpha 0
    linear 0.5 alpha 1
    on hide:
        linear 0.5 alpha 0
