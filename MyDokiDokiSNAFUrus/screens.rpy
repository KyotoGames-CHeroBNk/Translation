    ...
    vbox:
        ...
        if not persistent.autoload or not main_menu:
            ...
            if main_menu:
                ...
                if met_club == "True":
                    textbutton _("Обратиться") action [ShowMenu("appeal"), SensitiveIf(renpy.get_screen("appeal") == None)]
            ...
            if persistent.end == "True":
                textbutton _("Руты") action [ShowMenu("routes"), SensitiveIf(renpy.get_screen("routes") == None)]

            if _in_replay:

                textbutton _("Окончание Воспроизведения") action EndReplay(confirm=True)
...
init -501 screen about():
    ...
    use game_menu(_("Об игре"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Создана с {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].\n\n[renpy.license!t]")
            ...
            hbox:
                ...
                if met_club == "True":
                    ...
                    vbox:
                        ...
                        label _("Киба")
                        if k_scene5 == "False":
                            text _("Текущий: ([k_appeal] / 10)")
                        if k_appeal >=10 and k_scene5 == "False":
                            text _("Доступна дружеская сцена!!")
                        elif k_scene5 == "True":
                            text _("Понятно!")
                    vbox:
                        style_prefix "radio"
                        label _("Моника")
                        if m_love1 == "False" and m_scene6 == "False":
                            text _("Текущий: ([m_appeal] / 10)")
                        if m_scene4 == "True" and midterms == "False" and m_appeal >= 10:
                            text _("МАКСИМАЛЬНЫЙ (на данный момент)")
                        elif m_appeal >=10 and m_love1 == "False" and m_scene6 == "False":
                            text _("Доступна сцена рута!!")
                        elif m_love1 == "True" or m_scene6 == "True":
                            text _("Понятно!")
                    vbox:
                        style_prefix "radio"
                        label _("Нацуки")
                        if n_love3 == "False" and n_scene6 == "False":
                            text _("Текущий: ([n_appeal] / 10)")
                        if n_scene4 == "True" and midterms == "False" and n_appeal >= 10:
                            text _("МАКСИМАЛЬНЫЙ (на данный момент)")
                        elif n_appeal >=10 and n_love3 == "False" and n_scene6 == "False":
                            text _("Доступна сцена рута!!")
                        elif n_love3 == "True" or n_scene6 == "True":
                            text _("Понятно!")
                    if met_rikka == "True":
                        vbox:
                            style_prefix "radio"
                            label _("Рикка")
                            if r_love4 == "False" and r_scene7 == "False":
                                text _("Текущий: ([r_appeal] / 10)")
                            if r_scene5 == "True" and midterms == "False" and r_appeal >= 10:
                                text _("МАКСИМАЛЬНЫЙ (на данный момент)")
                            elif r_appeal >=10 and r_love4 == "False" and r_scene7 == "False":
                                text _("Доступна сцена рута!!")
                            elif r_love4 == "True" or r_scene7 == "True":
                                text _("Понятно!")
                    vbox:
                        style_prefix "radio"
                        label _("Сайори")
                        if s_love3 == "False" and s_scene7 == "False":
                            text _("Текущий: ([s_appeal] / 10)")
                        if s_scene4 == "True" and midterms == "False" and s_appeal >= 10:
                            text _("МАКСИМАЛЬНЫЙ (на данный момент)")
                        elif s_appeal >=10 and s_love3 == "False" and s_scene7 == "False":
                            text _("Доступна сцена рута!!")
                        elif s_love3 == "True" or s_scene7 == "True":
                            text _("Понятно!")
                    vbox:
                        style_prefix "radio"
                        label _("Юри")
                        if y_love2 == "False" and y_scene8 == "False":
                            text _("Текущий: ([y_appeal] / 10)")
                        if y_scene4 == "True" and midterms == "False" and y_appeal >= 10:
                            text _("МАКСИМАЛЬНЫЙ (на данный момент)")
                        elif y_appeal >=10 and y_love2 == "False" and y_scene8 == "False":
                            text _("Доступна сцена рута!!")
                        elif y_love2 == "True" or y_scene8 == "True":
                            text _("Понятно!")
            ...
            hbox:
                ...
                if stats_list == "True":
                    ...
                    vbox:
                        ...
                        label _("Атлетизм")
                        if ath_lvl3 == "False":
                            text _("Текущий: ([a_appeal] / 15)")
                        if ath_lvl1 == "False":
                            text _("Не имеющий ранга")
                        if ath_lvl1 == "True" and ath_lvl2 == "False":
                            text _("Первый ранг")
                        if ath_lvl2 == "True" and ath_lvl3 == "False":
                            text _("Второй ранг")
                        if ath_lvl3 == "True":
                            text _("МАКСИМУМ: Третий ранг")

                    vbox:
                        style_prefix "radio"
                        label _("Интеллект")
                        if int_lvl3 == "False":
                            text _("Текущий: ([i_appeal] / 15)")
                        if int_lvl1 == "False":
                            text _("Не имеющий ранга")
                    ...
                    vbox:
                        style_prefix "radio"
                        label _("Коммуникабельность")
                        if soc_lvl3 == "False":
                            text _("Текущий: ([c_appeal] / 15)")
                        if soc_lvl1 == "False":
                            text _("Не имеющий ранга")
...
init -501 screen routes():
    ...
    use game_menu(_("Настройки"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Добро пожаловать в Руты! Здесь вы можете просмотреть основную историю каждого Докича в виде")
            text _("более линейная/традиционная мода!")
            ...
            vbox:
                ...
                vbox:
                    ...
                    yalign 1.0
                    style_prefix "navigation"
                    textbutton _("Моника") action Jump(m_route)

                vbox:
                    style_prefix "navigation"
                    textbutton _("Нацуки") action Jump(n_route)

                vbox:
                    style_prefix "navigation"
                    textbutton _("Рикка") action Jump(r_route)

                vbox:
                    style_prefix "navigation"
                    textbutton _("Сайори") action Jump(s_route)

                vbox:
                    style_prefix "navigation"
                    textbutton _("Юри") action Jump(y_route)

            null height (10 * gui.pref_spacing)

            text _("{i}Примечание: Чтобы предотвратить возникновение ошибок, следует запускать только 'Руты'.")
            text _("{i}из Заголовочного Главного Меню.")
            text _("{i}Этот режим также не содержит сцен, связанных с конкретными событиями (например, Золотая неделя")
            text _("{i}и промежуточные экзамены), сцены апелляции или сцены после зачета.")
...
init -1 python:
    def FileActionMod(name, page=None, **kwargs):
        if persistent.playthrough == 1 and not persistent.deleted_saves and renpy.current_screen().screen_name[0] == "load" and FileLoadable(name):
            return Show(screen="dialog", message="Ошибка в файле: \"characters/sayori.chr\"\n\nФайл отсутствует или поврежден.",
                ok_action=Show(screen="dialog", message="Файл сохранения поврежден. Запускаем новую игру.", ok_action=Function(renpy.full_restart, label="start")))
        elif persistent.playthrough == 3 and renpy.current_screen().screen_name[0] == "save":
            return Show(screen="dialog", message="Больше нет смысла сохраняться.\nНе волнуйся, я никуда не собираюсь уходить.", ok_action=Hide("dialog"))
        else:
            ...
            hbox:
                ...
                if config.developer:
                    vbox:
                        ...
                        textbutton _("Отключён") action Preference("rollback side", "disable")
