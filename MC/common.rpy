# TODO: Translation updated at 2026-01-04 03:31
...
translate rus strings:
    ...
    new "Озвучивание содержимого буфера обмена включено."
    ...
    new "Текст с высокой контрастностью"
    ...
    new "Снижение громкости самоозвучивания"

    # renpy/common/00accessibility.rpy:224
    old "The options on this menu are intended to improve accessibility. They may not work with all games, and some combinations of options may render the game unplayable. This is not an issue with the game or engine. For the best results when changing fonts, try to keep the text size the same as it originally was."
    new "Параметры в этом меню предназначены для улучшения доступности. Они могут не работать во всех играх, а некоторые комбинации параметров могут сделать игру неиграбельной. Это не является проблемой игры или движка. Для наилучших результатов при смене шрифтов старайтесь сохранять исходный размер текста."
    ...
    new "Интерактивный режиссёр здесь не включён."
    ...
    new "Вы уверены, что хотите пропустить невидимый диалог до следующего выбора?"
    ...
    new "Эта программа содержит свободное ПО под рядом лицензий, включая MIT License и GNU Lesser General Public License. Полный список ПО, включая ссылки на полный исходный код, можно найти {a=https://www.renpy.org/l/license}здесь{/a}."
    ...
    new "автопродвижение после клика"
    ...
    new "Самоозвучивание сказало бы \"[renpy.display.tts.last]\". Нажмите 'alt+shift+V', чтобы отключить."
    ...
    new "Выбор расположения изображений"
    ...
    new "Нет объектов для просмотра."
    ...
    new "Кэш изображений: [cache_pct:.1f]% ([cache_size_mb:.1f] МБ)"
    ...
    new "Инспектор отображаемых элементов"
    ...
    old "displayable:"
    new "отображаемый элемент:"

    # renpy/common/_developer/inspector.rpym:145
    old "        (no properties affect the displayable)"
    new "        (свойства не влияют на отображаемый элемент)"

    # renpy/common/_developer/inspector.rpym:147
    old "        (default properties omitted)"
    new "        (стандартные свойства опущены"
    ...
    new "Соединение с магазином приложений\nПожалуйста, подождите..."

    # renpy/common/00updater.rpy:391
    old "The Ren'Py Updater is not supported on mobile devices."
    new "Обновлятор Ren'Py не поддерживается на мобильных устройствах."
    ...
    new "У этой учётной записи нет прав на запись в журнал обновлений."
    ...
    new "Файл обновления имеет неверный дайджест — возможно, он повреждён."
    ...
    new "[u.version] доступно. Хотите установить?"
    ...
    new "На этом компьютере используется программный рендеринг."

    # renpy/common/00gltest.rpy:249
    old "This game requires use of GL2 that can't be initialised."
    new "Для этой игры требуется GL2, который не удаётся инициализировать."
    ...
    new "Возможно, драйверы графики устарели или работают некорректно. Это может привести к медленной или некорректной отрисовке графики."

    # renpy/common/00gltest.rpy:259
    old "The {a=edit:1:log.txt}log.txt{/a} file may contain information to help you determine what is wrong with your computer."
    new "Файл {a=edit:1:log.txt}log.txt{/a} может содержать информацию, которая поможет определить, что не так с вашим компьютером."

    # renpy/common/00gltest.rpy:264
    old "More details on how to fix this can be found in the {a=[url]}documentation{/a}."
    new "Более подробные сведения о том, как это исправить, можно найти в {a=[url]}документации{/a}."
    ...
    new "Копирует файл traceback.txt в буфер обмена в формате BBcode для форумов вроде https://lemmasoft.renai.us/."
    ...
    new "Попытка отката к предыдущему моменту, чтобы вы могли сохранить игру или выбрать другой вариант."
    ...
    new "Игнорирует исключение, позволяя продолжить игру. Часто это приводит к дополнительным ошибкам."
